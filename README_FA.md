...
## 🖥️ اپلیکیشن دسکتاپ (جدید!)

اکنون می‌توانید از نسخه گرافیکی (GUI) و بسیار راحتِ MasterVPN برای ویندوز و مک استفاده کنید و دیگر نیازی به درگیری با ترمینال ندارید!

- **[دانلود آخرین نسخه برای ویندوز و مک از اینجا](https://github.com/masterking32/MasterHttpRelayVPN/releases)**

**امکانات نسخه گرافیکی:**
- اتصال و قطع اتصال تنها با یک کلیک
- راهنمای نصب تعاملی و خودکار برای تنظیم `Code.gs`
- مدیریت داخلی گواهی امنیتی (نصب و بررسی با یک کلیک)
- مشاهده لاگ‌ها و وضعیت اتصال به صورت زنده

*(نکته برای کاربران مک: اگر بعد از دانلود ارور "اپلیکیشن آسیب دیده است" یا damaged app دریافت کردید، ترمینال را باز کنید و دستور `sudo xattr -cr /Applications/MasterVPN.app` را اجرا کنید)*
